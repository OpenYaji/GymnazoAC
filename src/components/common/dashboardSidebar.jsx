...
export default function DashboardSidebar({ collapsed, setCollapsed, mobileOpen, setMobileOpen }) {
  ...
  // --- NEW HELPER FUNCTION ---
  // This function correctly determines the active link.
  const getIsActive = (item) => {
    // The main Dashboard link should only be active on an exact match.
    if (item.path === '/student-dashboard') {
      return location.pathname === item.path;
    }
    // For all other links, they are active if the current URL starts with their path.
