  ...
  return (
    <>
      <div className="relative min-h-screen w-full flex items-center md:items-start justify-center md:pt-2">
        ...
        {/* Background Image and Overlay - Remains at the lowest z-index */}
        <div 
        ...
        {/* Back to Home Button - NOW FIXED (STICKY) to the viewport */}
        {/* The 'top' value is set to be responsive: 'top-16' (for small screens where Header is h-16) and 'sm:top-20' (for large screens where Header is h-20) 
           This is based on your <Header /> component structure. */}
        ...
        {/* Login Form Container - Add a large responsive top margin (mt-32) to ensure the form content starts below the fixed Header and the fixed Back button. */}
